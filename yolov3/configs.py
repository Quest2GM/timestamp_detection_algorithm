...
TRAIN_CLASSES               = "classification/2_names.txt"
TRAIN_ANNOT_PATH            = "classification/2_train.txt"
TRAIN_LOGDIR                = "log2"
TRAIN_CHECKPOINTS_FOLDER    = "weights/checkpoints2"
...
# TEST options
TEST_ANNOT_PATH             = "classification/2_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
